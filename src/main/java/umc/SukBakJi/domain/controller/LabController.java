...
public class LabController {
    ...
    public ResponseEntity<ApiResponse<List<InterestTopicDTO>>> getInterestTopicDTO(@RequestHeader("Authorization") String token) {
        ...
        List<InterestTopicDTO> topics = labService.getInterestTopics(member);
